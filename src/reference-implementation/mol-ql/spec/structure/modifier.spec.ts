...
describe('modifier', () => {
    ...
    it('includeSurroundings HEM 5 ang', function() {
        ...
        const atomsInSurr = B.struct.generator.querySelection({ selection: includeSurr, query: B.struct.generator.atomGroups() });
    ...
    it('includeSurroundings HEM 5 ang (whole residues)', function() {
        ...
        const atomsInSurr = B.struct.generator.querySelection({ selection: includeSurr, query: residues });
        const pivotAtomSet = AtomSelection.atomSets(Data.compile(HEM)(Data.ctx) as AtomSelection)[0];
        const atomsInSel = Data.compile(atomsInSurr)(Data.ctx) as AtomSelection;
